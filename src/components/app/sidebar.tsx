          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-sidebar-accent text-sidebar-accent-foreground before:bg-primary before:absolute before:top-1/2 before:left-0 before:h-5 before:w-1 before:-translate-y-1/2 before:rounded-r-full"
